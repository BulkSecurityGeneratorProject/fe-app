...
import com.neighboorhood.feapp.repository.PostRepository;
import com.neighboorhood.feapp.repository.search.PostSearchRepository;
...
import static com.neighboorhood.feapp.web.rest.TestUtil.sameInstant;
...
public class PostResourceIT {
     ...
     *
     * @see com.neighboorhood.feapp.repository.search.PostSearchRepositoryMockConfiguration
     */
    @Autowired
